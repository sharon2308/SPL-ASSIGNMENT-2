...
public abstract class MicroService implements Runnable {
    ...
    private LinkedBlockingQueue<Class<? extends Event>> myEvents; // holds all the event of this microservice
    private LinkedBlockingQueue<Class<? extends Broadcast>> myBroadcasts; // holds all the broadcasts of this microservice
    ...
    public MicroService(String name) {
        ...
        myEvents = new LinkedBlockingQueue<>();
        myBroadcasts = new LinkedBlockingQueue<>();
        landoFinished = false;
        this.name = name;
    }
    ...
    public void AddToMyEvents(Class<? extends Event> type){
        myEvents.add(type);
    }

    public void AddToMyBroadCast(Class<? extends Broadcast> type){
        myBroadcasts.add(type);
    }
    /**
    ...
    public LinkedBlockingQueue<Class<? extends Event>> getMyEvents() {
        return myEvents;
    }

    public LinkedBlockingQueue<Class<? extends Broadcast>> getMyBroadcasts() {
        return myBroadcasts;
    }
